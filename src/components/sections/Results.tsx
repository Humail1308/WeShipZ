  ...
  return (
    <section className="py-section-padding px-gutter max-w-container-max mx-auto" id="results">
      <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
        ...
        >
          <span className="font-label-mono text-label-mono text-electric-blue block mb-4">03 — PORTFOLIO</span>
          <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg">Portfolio.</h2>
        </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {projects.map((project, idx) => (
          ...
          >
            ...
            {/* Info */}
            <div className="p-6">
              <span className="font-label-mono text-label-mono text-electric-blue block mb-2">
                {project.tag}
              </span>
